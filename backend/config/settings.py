...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('MYSQL_DATABASE', 'merxylab'),
...
CERT_VERIFY_RATE_LIMIT = int(os.getenv("CERT_VERIFY_RATE_LIMIT", "120"))
CERT_VERIFY_RATE_WINDOW_SECONDS = int(os.getenv("CERT_VERIFY_RATE_WINDOW_SECONDS", "300"))
CERT_VERIFY_RATE_LOCK_SECONDS = int(os.getenv("CERT_VERIFY_RATE_LOCK_SECONDS", "300"))
